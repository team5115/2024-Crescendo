...
public class ShotFrom10Ft extends SequentialCommandGroup {
    public ShotFrom10Ft(boolean actuallyRun, Drivetrain drivetrain, Intake intake, Shooter shooter, Arm arm, DigitalInput sensor, AutoAimAndRange autoAimAndRange) {
