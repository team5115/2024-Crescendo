...
public class DriveUntilDistanceFromAprilTag extends Command{
    ...
    public DriveUntilDistanceFromAprilTag(AutoAimAndRange autoAimAndRange) {
    ...
    @Override
    public void execute(){
        errors = autoAimAndRange.driveToDistance(2.3904);
    }
