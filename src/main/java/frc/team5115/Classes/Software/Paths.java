...
// from top note 
    public final static PathPlannerPath AutoNoteToNote1 = PathPlannerPath.fromPathFile("Path Uno");
    public final static PathPlannerPath AutoNoteToNote2 = PathPlannerPath.fromPathFile("top to bottom");

// from middle note
    public final static PathPlannerPath AutoNoteToNote3 = PathPlannerPath.fromPathFile("middle to bottom");
    public final static PathPlannerPath AutoNoteToNote4 = PathPlannerPath.fromPathFile("middle to top");

// from bottom note
    public final static PathPlannerPath AutoNoteToNote5 = PathPlannerPath.fromPathFile("bottom to top");
